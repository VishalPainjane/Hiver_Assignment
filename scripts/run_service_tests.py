...
async def run_suite():
    print("\n" + "=" * 80)
    print("RUNNING FASTAPI MICROSERVICE INTEGRATION & CACHING TESTS")
    print("=" * 80)
    ...
    async with lifespan(app):
        ...
        # 3. Single Item Cache Miss (GPU Inference)
        print("\n[TEST 3] POST /classify (Cache Miss -> GPU Inference)")
        ...
        batch_queries = [
            ...
            "I was charged $14.99 on my iTunes receipt for an unauthorized in-app purchase",  # Duplicate query
